...
public class MarkdownTransformer implements CustomTransformer
{
        ...
        throws Exception
    {
        ...
        File input = transformManager.createSourceFile();
        File output = transformManager.createTargetFile();

        RuntimeExec runtimeExec = new RuntimeExec();
        Map<String, String[]> commandsAndArguments = new HashMap<>();
        commandsAndArguments.put(".*", new String[] { pandocExe, "-s", "-o", output.getAbsolutePath(), input.getAbsolutePath() });
